...
// // console.log("patient123",patient)
// // const aclPatients = patient.slice(1)
// // console.log(aclPatients)
// const transformPatient = [];

// patient.forEach((patient:any,index:number) => {
//   if (index > 0) {
...
//         }
//         console.log(obj)
//     transformPatient.push(obj)
//   }
// });

// return transformPatient;
